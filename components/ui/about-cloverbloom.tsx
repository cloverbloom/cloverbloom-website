  ...
  return (
    <section className="relative w-full bg-background text-foreground">
      ...
      <img
        src="/arrow-03.svg"
        alt=""
        className="pointer-events-none absolute left-[calc(50%+380px)] top-[calc(75%-160px)] w-12 opacity-80 md:w-16"
        aria-hidden="true"
        draggable={false}
      />
      <CTA />
      <div className="pointer-events-none absolute inset-x-0 bottom-0 z-10 flex w-full items-end justify-end pr-6 md:pr-10 2xl:pr-10">
        <img
          src="/headshot.png"
          alt="Garrett headshot"
          className="block h-64 w-auto object-contain 2xl:h-80"
          draggable={false}
        />
      </div>
    </section>
